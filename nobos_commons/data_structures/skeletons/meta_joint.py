...
class MetaJoint(object):
    __slots__ = ['name', 'x', 'y', 'z', 'rotation', 'forward_vec', 'score', 'visibility']

    def __init__(self, num: float = -1, name: str = None, x: float = 0, y: float = 0, z: float = 0, score: float = 0,
                 visibility: JointVisibility = JointVisibility.VISIBLE, rotation: Quaternion = None, forward_vec: Vec3D = None):
        """
        ...
        self.forward_vec: Vec3D = forward_vec
