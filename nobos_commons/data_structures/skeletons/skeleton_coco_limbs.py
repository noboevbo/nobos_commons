...
from nobos_commons.data_structures.skeletons.skeleton_coco_joints import SkeletonCocoJoints
...
class SkeletonCocoLimbs(SkeletonLimbsBase):
    def __init__(self, skeleton_joints: SkeletonCocoJoints):
        ...
        self._nose_to_right_eye: Limb2D = Limb2D(num=1,
                                                 joint_from=skeleton_joints.nose,
                                                 joint_to=skeleton_joints.right_eye)
        self._left_eye_to_left_ear: Limb2D = Limb2D(num=2,
                                                    joint_from=skeleton_joints.left_eye,
                                                    joint_to=skeleton_joints.left_ear)
        self._right_eye_to_right_ear: Limb2D = Limb2D(num=3,
                                                      joint_from=skeleton_joints.right_eye,
                                                      joint_to=skeleton_joints.right_ear)
        self._left_ear_to_left_shoulder: Limb2D = Limb2D(num=4,
                                                         joint_from=skeleton_joints.left_ear,
                                                         joint_to=skeleton_joints.left_shoulder)
        self._right_ear_to_right_shoulder: Limb2D = Limb2D(num=5,
        ...
        self._right_shoulder_to_right_elbow: Limb2D = Limb2D(num=7,
        ...
        self._right_elbow_to_right_wrist: Limb2D = Limb2D(num=9,
                                                          joint_from=skeleton_joints.right_elbow,
                                                          joint_to=skeleton_joints.right_wrist)
        self._left_shoulder_to_left_hip: Limb2D = Limb2D(num=10,
                                                         joint_from=skeleton_joints.left_shoulder,
                                                         joint_to=skeleton_joints.left_hip)

        self._right_shoulder_to_right_hip: Limb2D = Limb2D(num=11,
                                                           joint_from=skeleton_joints.right_shoulder,
        ...
        self._right_hip_to_right_knee: Limb2D = Limb2D(num=13,
        ...
        self._right_knee_to_right_ankle: Limb2D = Limb2D(num=15,
    ...
    @property
    def left_ear_to_left_shoulder(self) -> Limb2D:
        return self._left_ear_to_left_shoulder

    @property
    def right_ear_to_right_shoulder(self) -> Limb2D:
        return self._right_ear_to_right_shoulder
    ...
    @property
    def left_shoulder_to_left_hip(self) -> Limb2D:
        return self._left_shoulder_to_left_hip

    @property
    def right_shoulder_to_right_hip(self) -> Limb2D:
        return self._right_shoulder_to_right_hip
