...
class SkeletonCocoJoints(SkeletonJointsBase):
    def __init__(self):
        ...
        self._left_eye: Joint2D = Joint2D(num=1, name='left_eye')
        self._right_eye: Joint2D = Joint2D(num=2, name='right_eye')
        self._left_ear: Joint2D = Joint2D(num=3, name='left_ear')
        self._right_ear: Joint2D = Joint2D(num=4, name='right_ear')
